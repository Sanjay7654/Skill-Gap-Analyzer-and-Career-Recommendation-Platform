        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-950 px-4 transition-colors">
            <div className="max-w-md w-full p-10 bg-gray-900 rounded-[2.5rem] shadow-2xl border border-gray-800 transition-colors">
                <div className="text-center mb-10">
                    <h1 className="text-4xl font-black text-gray-900 dark:text-white tracking-tighter uppercase mb-2">Sign Up</h1>
                    <p className="text-gray-400 dark:text-indigo-400 font-bold text-xs uppercase tracking-widest">Start your journey</p>
                </div>
                ...
                <p className="mt-8 text-center text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">
                    ...
                    <Link to="/login" className="text-indigo-600 dark:text-indigo-400 hover:text-gray-900 dark:hover:text-white">Sign In</Link>
                </p>
            </div>
        </div>
    );
